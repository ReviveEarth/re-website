  ...
  return (
    <>
      <section className="pt-4 md:pt-0 md:py-12 px-5 bg-ConversionKit h-[1100px] md:h-[900px] lg:h-[750px] bg-cover bg-no-repeat">
        <div className="flex flex-col items-center font-clashdisplay">
        ...
        <div className="mt-20 md:mt-32 text-white flex flex-col md:flex-row mx-16 md:mx-0 xl:mx-44 gap-5 md:gap-10 lg:gap-20 font-medium">
          <div className="flex flex-col">
            <h1 className="text-8xl font-clashdisplay">1</h1>
            <h3 className="text-xl font-clashdisplay">Request a Quote</h3>
          ...
          <div className="flex flex-col">
            <h1 className="text-8xl font-clashdisplay">2</h1>
            <h3 className="text-xl font-clashdisplay">Make Payment</h3>
            <p className="pt-2 text-sm font-normal w-[218px] md:w-full lg:w-[218px]">
          ...
          <div className="flex flex-col">
            <h1 className="text-8xl font-clashdisplay">3</h1>
